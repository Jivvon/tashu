...
import MarkerFlag from 'assets/marker.png';
...
const MapViewScreen = ({navigation}) => {
    ...
    return <>
        <NaverMapView style={{width: '100%', height: '100%'}}
                      ...
                      useTextureView>
            <Marker coordinate={P0} onClick={() => console.warn('onClick! p0')} caption={{text: "test caption"}}/>
            <Marker coordinate={P1} pinColor="blue" onClick={() => console.warn('onClick! p1')}/>
            <Marker coordinate={P2} pinColor="red" onClick={() => console.warn('onClick! p2')}/>
            <Marker coordinate={P4} onClick={() => console.warn('onClick! p4')} image={MarkerFlag} width={48} height={48}/>
